          ...
          <div class="medium-12 columns">
            <h4>Your Vital Stats</h4>
              ...
              <div class="row">
                ...
                <div class="medium-10 columns required" id="gender-input">
                  ...
                  <input type="radio" name="gender" value="Males" id="Males"><label for="Males" class="right inline">Fill in the blank</label>
                  <input type="text" name="gender-custom" value="" id="Custom" style="max-width: 10rem;"> 
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="medium-10 columns required" id="gender-input">
                  <input type="text" name="age" value="" id="Years" style="width: 10rem;" class="left inline"><label for="Years" class="inline">&nbsp;&nbsp;years old</label>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="medium-10 columns required" id="gender-input">
                  <input type="text" name="height-ft" value="" id="Feet" style="width: 5rem;" class="left inline"><label for="Feet" class="inline">&nbsp;&nbsp;feet</label>
                  <input type="text" name="height-in" value="" id="Inches" style="width: 5rem;" class="left inline"><label for="Inches" class="inline">&nbsp;&nbsp;inches</label>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="medium-10 columns required" id="gender-input">
                  <input type="text" name="weight" value="" id="Pounds" style="width: 10rem;" class="left inline"><label for="Pounds" class="inline">&nbsp;&nbsp;lbs</label>
                </div>
              </div>
